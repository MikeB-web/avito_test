...
class Parse
{
 ...
 private function error()
 {
  ...
  $err2=preg_replace($a, $b, $err);
   ...
   if (is_writable("error.json")) {
    file_put_contents("error.json", $err2);
  } else {
...
\r\n}";
  ...
  if (is_writable("StructureWithValues.json")) {
    file_put_contents("StructureWithValues.json", $rep);
  } else {
    echo 'Файл недоступен для записи';
  }
...
$json2=file_get_contents("TestcaseStructure.json");
$arr2=file_get_contents("Values.json");
